<template>
  <div class="basket">
    <div class="items">
      ...
      <!-- Onglet du panier -->
      <!-- Affichage s'il y a au moins un article dans le panier -->
      <template v-if="productsInBag.length">
        ...
        <div v-for="(product, index) in productsInBag" :key="index" class="item">
          ...
          <div class="photo">
            <img :src="product.image" alt="product, buying, item">
          </div>
          ...
          <div class="price">
            <span class="quantity-area">
              <!-- Activation du bouton à partir d'une quantité -->
      ...
      <!-- Affichage si le panier d'articles est vide -->
      <template v-else>
